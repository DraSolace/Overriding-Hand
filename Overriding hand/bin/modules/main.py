...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.ui.GitBranchBut.clicked.connect(lambda: self.showPopUp("О нет...", "Ещё не существует на GitHub"))
        self.ui.GitPullBut.clicked.connect(lambda: self.showPopUp("О нет...", "Ещё не существует на GitHub"))
        self.ui.gitHubBut.clicked.connect(lambda: self.showPopUp("О нет...", "Ещё не существует на GitHub"))
