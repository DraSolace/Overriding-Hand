...
Клиент-макросник c GUI на чистом питоне, для которого я сделал свой алгоритмический язык программирования **"Overscript"** <sub><sup> (пожалуйста, не смотри как работает интерпретатор для него, или хотя бы не смейся) </sub></sup>
